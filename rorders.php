...
<?php 
    ...
    $query = "SELECT * FROM orders WHERE r_id=$id";
    ...
    if ($result->num_rows > 0) {
        ...
        while($row = $result->fetch_assoc()) {
            ...
            <tr>
                ...
                <td><?php echo $type ?> </td>
                <td>
                <a href="ordercomp.php?id=<?php echo $row["o_id"]; ?>"><button class="btn-xs" style="color:white;background-color:orangered;border:0px;border-radius:5px;width:50px">Ok</button</a>
                </td>
            </tr>
            <?php
        }
