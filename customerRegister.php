        ...
        $(document).ready(function() {
            $("#register").click(function() {
                ...
                $.ajax({
                    type: "POST",
                    url: "adduser.php",
                    data: "fname="+fname+"&lname="+lname+"&email="+email+"&password="+password+"&veg="+veg+"&nonveg="+nonveg,
                    success:function(html) {
                        if (html == 'true') {
                            ...
                            $("#adderr").html('<div class="alert alert-danger">\
                                                <strong>Check </strong>the checkbox!</div>');
                        }
                        else {
                            $("#adderr").html('<div class="alert alert-danger">\
  ...
  <section class="page-section ">
    ...
    <div class="bg-faded rounded p-5" >
        <div class="col-lg-12 mt-5" >
            <hr>
            <h2 class="intro-text text-center" style="color:whitesmoke">Customer Register
            </h2>
            ...
            <form role="form">
                            <div class="row" style="color:grey">
                                ...
                                <div class="form-group col-lg-12">
                                    ...
                                    <div class="checkbox">
                                    <label><input type="checkbox" id="veg" name="veg" value="yes">&nbsp Vegetarian</label>
                                    </div>
                                    <div class="checkbox">
                                    <label><input type="checkbox" id="nonveg" name="nonveg" value="yes">&nbsp Non-vegetarian</label>
                                    </div>
                                </div>
                                <div class="register-button col-lg-12">
                                <span display="flex">
                                            <label>Already a Member?</label>
                                            <a style="color:orangered" href="customerLogin.php">Login</a>
                                        </span>
